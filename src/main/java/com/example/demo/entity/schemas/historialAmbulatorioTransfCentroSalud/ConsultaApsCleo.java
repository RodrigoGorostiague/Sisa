...
@Entity
@Table(schema = "historialambulatorio_tansf_csalud", name = "consultaapscleo")
public class ConsultaApsCleo {
    @EmbeddedId
    private ConsultaApsCleoPK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsCleoPK getId() {
        return id;
    }

    public void setId(ConsultaApsCleoPK id) {
        this.id = id;
    }
