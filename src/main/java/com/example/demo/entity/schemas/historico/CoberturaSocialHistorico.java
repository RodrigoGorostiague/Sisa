...
public class CoberturaSocialHistorico {
    @EmbeddedId
    private CoberturaSocialHistoricoPK id;
    ...
    public CoberturaSocialHistoricoPK getId() {
        return id;
    }

    public void setId(CoberturaSocialHistoricoPK id) {
        this.id = id;
    }
