...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapsvinorte")
public class ConsultaApsViNorte {
    @EmbeddedId
    private ConsultaApsViNortePK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsViNortePK getId() {
        return id;
    }

    public void setId(ConsultaApsViNortePK id) {
        this.id = id;
    }
