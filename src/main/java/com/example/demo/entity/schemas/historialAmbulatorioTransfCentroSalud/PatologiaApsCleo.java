...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "patologiaapscleo")
public class PatologiaApsCleo {
    @EmbeddedId
    private PatologiaApsCleoPK id;
    @Column(name = "nombrepatologia")
    private String nombrePatologia;

    public PatologiaApsCleoPK getId() {
        return id;
    }

    public void setId(PatologiaApsCleoPK id) {
        this.id = id;
    }
