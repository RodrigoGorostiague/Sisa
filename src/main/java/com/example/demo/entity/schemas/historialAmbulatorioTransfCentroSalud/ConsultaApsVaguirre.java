...
@Entity
@Table(schema = "historialambulatorio_tansf_csalud", name = "consultaapsvaguirre")
public class ConsultaApsVaguirre {
    @EmbeddedId
    private ConsultaApsVaguirrePK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsVaguirrePK getId() {
        return id;
    }

    public void setId(ConsultaApsVaguirrePK id) {
        this.id = id;
    }
