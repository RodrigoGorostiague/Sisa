...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "infimportantetuni")
public class InfImportanteTuni {
    @EmbeddedId
    private InfImportanteTuniPK id;
    ...
    public InfImportanteTuniPK getId() {
        return id;
    }

    public void setId(InfImportanteTuniPK id) {
        this.id = id;
    }
