...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapsvela")
public class ConsultaApsVela {
    @EmbeddedId
    private ConsultaApsVelaPK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsVelaPK getId() {
        return id;
    }

    public void setId(ConsultaApsVelaPK id) {
        this.id = id;
    }
