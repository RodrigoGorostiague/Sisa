...
@Entity
@Table(name = "nomencladorvacunas_nuevo", schema = "plannacer")
public class NomencladorVacunasNuevo {
    @EmbeddedId
    private NomencladorVacunasNuevoPK id;
    ...
    public NomencladorVacunasNuevoPK getId() {
        return id;
    }

    public void setId(NomencladorVacunasNuevoPK id) {
        this.id = id;
    }
