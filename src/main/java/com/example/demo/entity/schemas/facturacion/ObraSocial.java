...
@Entity
@Table(name = "obrasocial", schema = "facturacion")
public class ObraSocial {
    ...
    public String getCodigoPostalCorr() {
        return codigoPostalCorr;
    }

    public void setCodigoPostalCorr(String codigoPostalCorr) {
        this.codigoPostalCorr = codigoPostalCorr;
    }
    ...
    public String getCapitada() {
        return capitada;
    }

    public void setCapitada(String capitada) {
        this.capitada = capitada;
    }
