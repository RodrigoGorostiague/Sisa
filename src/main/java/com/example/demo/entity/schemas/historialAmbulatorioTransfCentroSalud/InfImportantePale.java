...
@Entity
@Table(name = "InfImportantePale",schema = "historialambulatorio_transf_csalud")
public class InfImportantePale {
    @EmbeddedId
    private InfImportantePalePK id;
    ...
    public InfImportantePalePK getId() {
        return id;
    }

    public void setId(InfImportantePalePK id) {
        this.id = id;
    }
