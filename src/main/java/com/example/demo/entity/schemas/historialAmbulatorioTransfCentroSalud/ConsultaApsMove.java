...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapsmove")
public class ConsultaApsMove {
    @EmbeddedId
    private ConsultaApsMovePK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsMovePK getId() {
        return id;
    }

    public void setId(ConsultaApsMovePK id) {
        this.id = id;
    }
