...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapstuni")
public class ConsultaApsTuni {
    @EmbeddedId
    private ConsultaApsTuniPK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsTuniPK getId() {
        return id;
    }

    public void setId(ConsultaApsTuniPK id) {
        this.id = id;
    }
