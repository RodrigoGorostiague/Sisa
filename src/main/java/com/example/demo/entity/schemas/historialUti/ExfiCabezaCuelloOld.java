...
@Entity
@Table(name = "exficabezaycuelloold", schema = "historialuti")
public class ExfiCabezaCuelloOld {
    @Id
    @Column(name = "nrouti")
    ...
    @Column(name = "otrhallazgos")
    private String otrHallazgos;
    ...
    public String getFacie() {
        return facie;
    }

    public void setFacie(String facie) {
        this.facie = facie;
    }
    ...
    public String getOtrHallazgos() {
        return otrHallazgos;
    }

    public void setOtrHallazgos(String otrHallazgos) {
        this.otrHallazgos = otrHallazgos;
    }
}
