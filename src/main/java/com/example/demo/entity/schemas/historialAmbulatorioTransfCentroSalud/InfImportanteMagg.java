...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "infimportantemagg")
public class InfImportanteMagg {
    @EmbeddedId
    private InfImportanteMaggPK id;
    ...
    public InfImportanteMaggPK getId() {
        return id;
    }

    public void setId(InfImportanteMaggPK id) {
        this.id = id;
    }
