...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapsvela_1")
public class ConsultaApsVela1 {
    @EmbeddedId
    private ConsultaApsVela1PK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsVela1PK getId() {
        return id;
    }

    public void setId(ConsultaApsVela1PK id) {
        this.id = id;
    }
