...
@Entity
@Table(schema = "historialambulatoriio_transf_csalud", name = "consultaapspale")
public class ConsultaApsPale {
    @EmbeddedId
    private ConsultaApsPalePK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsPalePK getId() {
        return id;
    }

    public void setId(ConsultaApsPalePK id) {
        this.id = id;
    }
