...
@Entity
@Table(name = "otras_coberturas", schema = "facturacion")
public class OtrasCoberturas {
    @Id
    ...
    public String getParaInt() {
        return paraInt;
    }

    public void setParaInt(String paraInt) {
