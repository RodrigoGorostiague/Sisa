...
@Entity
@Table(schema = "historialambulatorio_transf_csalud", name = "consultaapsmeta")
public class ConsultaApsMeta {
    @EmbeddedId
    private ConsultaApsMetaPK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsMetaPK getId() {
        return id;
    }

    public void setId(ConsultaApsMetaPK id) {
        this.id = id;
    }
