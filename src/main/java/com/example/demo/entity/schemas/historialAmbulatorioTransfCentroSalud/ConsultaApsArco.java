...
@Entity
@Table(schema =  "historialambulatorio_transf_csalud", name = "consultaapsarco")
public class ConsultaApsArco {
    @EmbeddedId
    private ConsultaApsArcoPK id;
    @Column(name = "tipodoc")
    ...
    public ConsultaApsArcoPK getId() {
        return id;
    }

    public void setId(ConsultaApsArcoPK id) {
        this.id = id;
    }
